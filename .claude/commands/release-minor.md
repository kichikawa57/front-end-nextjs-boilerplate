---
description: Create a minor release (new feature) and push to remote
---

Please perform the following steps to create a minor release:

1. Run `pnpm changeset:add minor "Add: [describe the feature]"` with an appropriate description
